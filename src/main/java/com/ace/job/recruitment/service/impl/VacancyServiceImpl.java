...
public class VacancyServiceImpl implements VacancyService {
	...
	public VacancyDto getVacancyById(long id) {
		...
		Integer updatedUserId = vacancy.getUpdatedUserId();
		Integer safeUpdatedUserId = (updatedUserId != null) ? updatedUserId : 0;
		VacancyDto dto = new VacancyDto(vacancy.getId(), vacancy.getRequirement(), vacancy.getResponsibility(),
				...
				vacancy.getUpdatedTime(), vacancy.getCreatedUserId(), safeUpdatedUserId, vacancy.getDueDate(),
